![docker image](https://github.com/Atena-e/Nomad-SEM/actions/workflows/docker-publish.yml/badge.svg)


# Atena-e's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Atena-e.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Atena-e/Nomad-SEM.git
    cd Nomad-SEM
    ```
    ...
    ```sh
    curl-L -o Nomad-SEM.zip "https://github.com/Atena-e/Nomad-SEM/archive/main.zip"
    unzip Nomad-SEM.zip
    cd Nomad-SEM
    ```
...
your `docker-compose.yaml` with `ghcr.io/atena-e/nomad-sem:main` for the services
...
```sh
docker pull ghcr.io/atena-e/nomad-sem/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/Atena-e/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/Atena-e/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Atena-e/Nomad-SEM/manifests/main": unauthorized`
